...
char *parameternames[PARAMETER_NR] = { "phi", "rho", "rho2", "q", "beta", "eta1", "eta2","eta3", "E0", "ws","c"};

// Default values of all parameters
double parameter[PARAMETER_NR] = {0.1, 1.0, 1.0, 1.0, 1000.0, 1.0, 1.0, 1.0, 0.2, 0.5,0.1};
...
#define E0                        parameter[8]                                      // Additikonal mortality in the harvested area

#define WS                        parameter[9]                                      // Length at habitat switch (15 cm)
#define C                        parameter[10]                                      // Length at habitat switch (15 cm)
/*
 *====================================================================================================================================
