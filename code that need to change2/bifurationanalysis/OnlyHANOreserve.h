...
char *parameternames[PARAMETER_NR] = { "phi", "rho", "q", "beta", "eta1", "eta2", "fetj","feta","ws"};

// Default values of all parameters
double parameter[PARAMETER_NR] = {1.0, 0.5, 1.0, 2000.0, 0.8, 0.8, 0.1,0.1, 0.1};
...
#define FETJ                         parameter[6]                                      // Fishing effort immature individual in the non-breeding habitat harvested area
#define FETA                         parameter[7]                                      // Fishing effort adult individual in the non-breeding habitat harvested area
#define WS                         parameter[8]                                      // Size at habitat switch 
               ...
               double mortality[POPULATION_NR])
{
  ...
  {
    if (lifestage[0] == 2) mortality[0] = ETA2+FETA;
   else mortality[0] = ETA2+FETJ;
  }
  return;
}
