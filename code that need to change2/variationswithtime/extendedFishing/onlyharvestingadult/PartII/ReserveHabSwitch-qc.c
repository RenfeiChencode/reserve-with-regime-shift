...
#define E0SJ                      parameter[6]                                      // Scaled fishing mortality rate of juveniles in hab 2
#define E0SA                      parameter[7]                                      // Scaled fishing mortality rate of adults in hab 2
    ...
    for(i=0; i<cohort_no[CONS]; i++)
    {
        ...
        if (issmolted(i))
        {
            ...
            else
            {
                ...
                popgrad[CONS][i][age]    = 1.0;
                if (ismature(i)) popgrad[CONS][i][number] = ETA2 + E0SA;
                else popgrad[CONS][i][number] = ETA2 + E0SJ;
