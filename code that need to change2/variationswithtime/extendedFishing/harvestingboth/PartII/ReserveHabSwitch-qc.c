...
#define WS                        parameter[7]                                      // Default switch size (scaled)
#define Q                         parameter[8]                                      // Attack rate ratio on resource 1 and 2
#define BETA                      parameter[9]                                      // Scaled fecundity parameter
#define C                         parameter[10]                                     // Fraction of large consumers in reserve

#define HERITABILITY              parameter[11]                                     // Heritability of trait value (0.3)
#define GENETICVARIANCE           parameter[12]                                     // Half-width of the truncated normal distribution (0.25)
...

{
    ...
    for(i=0; i<cohort_no[CONS]; i++)
    {
        ...
        if (issmolted(i))
        {
            ...
            {
                popgrad[CONS][i][number] = ETA2 + E0S;
